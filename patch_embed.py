...
class PatchEmbed(nn.Module):
    ...
    def __init__(
        ...
        self.img_size, self.grid_size, self.num_patches, self.hw_num_patches = self._init_img_size(img_size)
    ...
    def _init_img_size(self, img_size: Union[int, Tuple[int, int]]):
        ...
        hw_num_patches = (grid_size[0], grid_size[1])
        return img_size, grid_size, num_patches, hw_num_patches
